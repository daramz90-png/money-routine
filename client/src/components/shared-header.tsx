...
export function SharedHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-950 text-white shadow-2xl">
      ...
      <div 
        className={`md:hidden fixed top-0 right-0 h-full w-64 z-50 bg-gradient-to-b from-slate-900 to-indigo-950 shadow-2xl transform transition-transform duration-300 ease-in-out ${
